...
@Service
public class CasoUsoGenerarGananciasRestaurante implements GanaciasHistoricasInputPort {

    private final GenerarGananciasOutputPort generarGananciasOutputPort;
    private final UsuariosFeing usuariosFeing;


    public CasoUsoGenerarGananciasRestaurante(GenerarGananciasOutputPort generarGananciasOutputPort,
